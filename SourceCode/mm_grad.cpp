...
//CHARMM 1.62 A, 0.1 kcal/mol
    ...
    else if (anumbers[i] == 30)
    {
      ffR[i] = 2.7;
      ffeps[i] = 0.005;
    }
    else if (anumbers[i] == 31)
    {
      ffR[i] = 2.8;
      ffeps[i] = 0.005;
    }
    ...
    else if (anumbers[i] == 37) //Rb
    {
      ffR[i] = 3.5;
      ffeps[i] = 0.005;
    }
    else if (anumbers[i] == 38)
    {
      ffR[i] = 3.5;
      ffeps[i] = 0.005;
    }
    ...
    else if (anumbers[i] == 50)
    {
      ffR[i] = 3.1;
      ffeps[i] = 0.005;
    }
    else if (anumbers[i] == 56)
    {
      ffR[i] = 3.1;
      ffeps[i] = 0.005;
    } 
    ...
    else if (anumbers[i] == 80)
    {
      ffR[i] = 3.6;
      ffeps[i] = 0.005;
    }
    else if (anumbers[i] == 81)
    {
      ffR[i] = 3.7;
      ffeps[i] = 0.005;
    }
    else if (anumbers[i] == 82)
    {
      ffR[i] = 3.7;
      ffeps[i] = 0.005;
    }
