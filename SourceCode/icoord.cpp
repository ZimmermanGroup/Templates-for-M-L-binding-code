...
double ICoord::getR(int i){
  ...
  else if (anumbers[i]==29) value = 3.0; //Cu
  else if (anumbers[i]==30) value = 3.0; //Zn
  else if (anumbers[i]==31) value = 3.0; //Ga
  else if (anumbers[i]==35) value = 2.7;
  else if (anumbers[i]==37) value = 3.0; //Rb
  else if (anumbers[i]==38) value = 3.0; //Sr
  ...
  else if (anumbers[i]==48) value = 3.25; //Cd
  else if (anumbers[i]==50) value = 3.15; //Sn
  else if (anumbers[i]==53) value = 2.8; //iodine
  else if (anumbers[i]==55) value = 4.2;
  else if (anumbers[i]==56) value = 3.0;
  ...
  else if (anumbers[i]==80) value = 3.45; //Hg
  else if (anumbers[i]==81) value = 3.40; //Tl
  else if (anumbers[i]==82) value = 3.40;
  else 
  {
